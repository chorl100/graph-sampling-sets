...
class Preprocessor:
    ...
    def __init__(self, from_date, to_date, limit: int = None, features: typing.List[str] = constants.RELEVANT_COLUMNS,
                 data: pd.DataFrame = None, verbose=True):
        """
    ...
    def _get_dict_path():
        ...
        return "src/db/resources/imputation_dictionary.csv"
